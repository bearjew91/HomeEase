  ...
  en: {
    ...
    budget: {
      ...
      form: {
        ...
        intro: 'All inputs stay local — nothing leaves your browser.',
        calculate: 'Calculate affordability',
        netIncome: { label: 'Net monthly household income (₪)', placeholder: '18,000', hint: 'Combined household take-home pay.' },
        expenses: { label: 'Current monthly expenses (₪)', placeholder: '10,000', hint: 'Lifestyle spend — food, transport, kids, insurance, etc.' },
        existingLoans: { label: 'Existing loan payments (₪/mo)', placeholder: '1,500', hint: 'Car loans, consumer loans, student loans — recurring monthly.' },
        rentUntilEntry: { label: 'Rent until move-in (₪/mo)', placeholder: '5,500', hint: 'Optional. Many lottery projects take 3–5 years to deliver.' },
        cashSavings: { label: 'Available cash savings (₪)', placeholder: '300,000', hint: 'Total liquid savings before subtracting reserves.' },
        emergencyFund: { label: 'Emergency fund to keep (₪)', placeholder: '54,000', hint: 'Optional. Defaults to 3× net monthly income.' },
        extraCosts: { label: 'Extra purchase costs (₪)', placeholder: '50,000', hint: 'Lawyer, moving, furniture, indexation buffer.' },
        hasGrant: { label: 'Project qualifies for the eligible-buyer grant', hint: 'Check only if confirmed via the official project list.' },
        interestRate: { label: 'Planning interest rate (%)', placeholder: '5.0', hint: 'Conservative blended rate. Banks set the real rate at signing.' },
        termYears: { label: 'Mortgage term (years)', placeholder: '30', hint: 'Max 30 years per BoI directive 329.' },
      },
      results: {
        title: 'Your envelope',
        equityForApartment: 'Equity available for the apartment',
        equityForApartmentFoot: 'Cash savings minus the emergency reserve and extra purchase costs.',
        safeMonthlyCapacity: 'Safe monthly housing payment',
        safeMonthlyCapacityFoot: 'Lower of 30% of net income and 70% of free cashflow.',
        estimatedMaxPrice: 'Estimated max purchase price',
        estimatedMaxPriceFoot: 'Equity + the loan your monthly capacity supports — verified against BoI LTV/PTI rules.',
        breakdown: 'Breakdown',
        monthlyFreeCashflow: 'Free monthly cashflow',
        maxLoanByIncome: 'Max loan by income',
        savingsRate: 'Savings rate',
        savingsRateSuffix: 'of net income',
        emergencyReserve: 'Emergency reserve kept aside',
        extraCostsReserved: 'Purchase-related costs reserved',
        warn: 'This is a planning estimate, not a bank approval. Real terms depend on appraisal, credit profile, mortgage mix, and the rate at signing.',
      ...
      next: {
        ...
        body: 'The mortgage estimator turns these numbers into a concrete loan envelope: max principal, monthly payment, and a green / yellow / orange / red planning category.',
  ...
  he: {
    ...
    budget: {
      ...
      form: {
        ...
        netIncome: { label: "הכנסה חודשית נטו של משק הבית (₪)", placeholder: "18,000", hint: "הסכום שבאמת נכנס לחשבון, אחרי מסים." },
        expenses: { label: "הוצאות חודשיות שוטפות (₪)", placeholder: "10,000", hint: "אורח חיים — אוכל, תחבורה, ילדים, ביטוחים." },
        existingLoans: { label: "החזרי הלוואות קיימים (₪ בחודש)", placeholder: "1,500", hint: "הלוואות צרכניות, רכב, סטודנט — חודשי." },
        rentUntilEntry: { label: "שכירות עד הכניסה לדירה (₪ בחודש)", placeholder: "5,500", hint: "אופציונלי. בדירות בהגרלות לרוב לוקח 3–5 שנים עד מסירה." },
        cashSavings: { label: "חיסכון נזיל זמין (₪)", placeholder: "300,000", hint: "סך החיסכון לפני שמורידים רזרבות." },
        emergencyFund: { label: "כרית חירום לשמור (₪)", placeholder: "54,000", hint: "אופציונלי. ברירת מחדל: פי 3 מההכנסה החודשית." },
        extraCosts: { label: "עלויות רכישה נוספות (₪)", placeholder: "50,000", hint: "עו\"ד, מעבר, ריהוט, כרית הצמדה." },
        hasGrant: { label: "הפרויקט זכאי למענק לזכאים", hint: "לסמן רק אם מאומת ברשימת הפרויקטים הרשמית." },
        interestRate: { label: "ריבית תכנון (%)", placeholder: "5.0", hint: "ריבית שמרנית להערכה. הבנק יקבע את הריבית בפועל." },
        termYears: { label: "תקופת משכנתא (שנים)", placeholder: "30", hint: "עד 30 שנה לפי הוראת בנק ישראל 329." },
      },
      results: {
        title: "התקציב שלכם",
        equityForApartment: "הון עצמי שיופנה לדירה",
        equityForApartmentFoot: "חיסכון פחות כרית חירום ועלויות רכישה.",
        safeMonthlyCapacity: "החזר חודשי בטוח לדיור",
        safeMonthlyCapacityFoot: "המינימום בין 30% מההכנסה ל-70% מהתזרים הפנוי.",
        estimatedMaxPrice: "מחיר רכישה מקסימלי משוער",
        estimatedMaxPriceFoot: "הון עצמי + הלוואה שההחזר החודשי תומך בה — מאומת מול כללי LTV ו-PTI.",
        breakdown: "פירוט",
        monthlyFreeCashflow: "תזרים חודשי פנוי",
        maxLoanByIncome: "הלוואה מקסימלית לפי הכנסה",
        savingsRate: "שיעור חיסכון",
        savingsRateSuffix: "מההכנסה",
        emergencyReserve: "כרית חירום שמורה",
        extraCostsReserved: "עלויות רכישה שמורות",
      ...
      next: {
        eyebrow: "הצעד הבא",
        title: "להפוך תקציב ליכולת משכנתא ברורה.",
        body: "מחשבון המשכנתא מתרגם את המספרים להלוואה בפועל — סכום מקסימלי, החזר חודשי, וקטגוריית תכנון בצבעים: ירוק / צהוב / כתום / אדום.",
